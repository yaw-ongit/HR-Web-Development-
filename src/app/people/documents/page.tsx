      ...
      <SectionContainer>
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="text-3xl font-semibold text-slate-900">Dokumen karyawan</h1>
            <p className="mt-2 text-sm text-slate-400">Pusat dokumen untuk kontrak karyawan, catatan kepatuhan, dan arsip HR.</p>
          </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[1.6fr_1fr]">
        <Card className="rounded-[28px] border border-slate-200 bg-slate-50/95 p-6 shadow-card">
          <div className="flex items-center justify-between gap-4">
            <div>
                <p className="text-sm uppercase tracking-[0.3em] text-slate-400">Pusat dokumen</p>
                <h2 className="mt-2 text-2xl font-semibold text-slate-900">File karyawan terbaru</h2>
              </div>
              ...
              {documentCenter.map((document) => (
                <div key={document.title} className="rounded-3xl border border-slate-200 bg-white/80 p-5 transition hover:border-brand-500">
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <span className="rounded-full bg-slate-50/90 px-3 py-1 text-xs uppercase tracking-[0.28em] text-slate-700">{document.status}</span>
                  </div>
