  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="min-h-screen bg-white text-slate-900 antialiased">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:rounded-2xl focus:bg-blue-600 focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-white focus:shadow-lg focus:outline-none"
        >
