...
export default function LeaveAnalyticsPage() {
  return (
    <div className="space-y-8 pb-12 pt-6 lg:pb-16">
      ...
      <SectionContainer>
        <div className="grid gap-4 md:grid-cols-2">
          <Card className="rounded-[28px] border border-border bg-surface/95 p-6 shadow-card">
            <p className="text-xs uppercase tracking-[0.3em] text-muted mb-6">Ikhtisar Saldo Cuti</p>
            <div className="space-y-4">
              {leaveBalanceData.map((leave) => (
                <div key={leave.leaveType} className="rounded-2xl bg-card/80 p-4">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm font-semibold text-foreground">{leave.leaveType}</p>
                    <span className="text-xs font-semibold text-muted">{leave.employees} karyawan</span>
                  </div>
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div>
                      <p className="text-xs text-muted">Alokasi</p>
                      <p className="text-sm font-semibold text-foreground">{leave.total}</p>
                    </div>
                    <div>
                      <p className="text-xs text-muted">Dipakai</p>
          ...
          <Card className="rounded-[28px] border border-border bg-surface/95 p-6 shadow-card">
            <p className="text-xs uppercase tracking-[0.3em] text-muted mb-6">Distribusi Jenis Cuti</p>
      ...
      <SectionContainer>
        <Card className="rounded-[28px] border border-border bg-surface/95 p-6 shadow-card">
          <p className="text-xs uppercase tracking-[0.3em] text-muted mb-6">Tren Persetujuan Cuti</p>
      ...
      <SectionContainer>
        <Card className="rounded-[28px] border border-border bg-surface/95 p-6 shadow-card">
          <p className="text-xs uppercase tracking-[0.3em] text-muted mb-6">Perbandingan Cuti Departemen</p>
      ...
      <SectionContainer>
        <Card className="rounded-[28px] border border-border bg-surface/95 p-6 shadow-card">
          <p className="text-xs uppercase tracking-[0.3em] text-muted mb-6">Waktu Proses Permintaan Cuti</p>
          <div className="space-y-3">
            <div className="rounded-2xl bg-card/80 p-4 flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-foreground">Rata-rata Waktu Proses</p>
                <p className="mt-1 text-xs text-muted">30 hari terakhir</p>
              </div>
              <span className="text-2xl font-semibold text-primary">2.3 hari</span>
            </div>
            <div className="rounded-2xl bg-card/80 p-4 flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-foreground">Departemen Tercepat</p>
                <p className="mt-1 text-xs text-muted">Keuangan - rata-rata 1.5 hari</p>
              </div>
              <span className="text-2xl font-semibold text-emerald-600">1.5d</span>
            </div>
            <div className="rounded-2xl bg-card/80 p-4 flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-foreground">Departemen Terlambat</p>
                <p className="mt-1 text-xs text-muted">Fasilitas - rata-rata 3.2 hari</p>
              </div>
