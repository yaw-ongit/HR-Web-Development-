  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'relative w-full rounded-[28px] border border-white/10 bg-slate-900 shadow-card',
          sizeClasses[size],
          className,
        )}
      >
        ...
        <div className="flex items-start justify-between gap-4 border-b border-white/10 px-6 py-5">
          ...
          <button
            ...
            onClick={onClose}
            className="rounded-full p-1.5 text-slate-400 transition hover:bg-slate-800 hover:text-slate-100 focus:outline-none focus:ring-2 focus:ring-sky-400"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
