...
export const attendanceCalendar: WorkforceCalendarDay[] = [
  ...
  { day: 5, weekday: 'Fr', status: 'WFH', color: 'bg-blue-50/50 text-blue-500', note: 'Remote work day' },
  ...
  { day: 16, weekday: 'Tu', status: 'WFH', color: 'bg-blue-50/50 text-blue-500', note: 'Remote day' },
