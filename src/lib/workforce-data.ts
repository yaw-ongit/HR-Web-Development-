...
export const attendanceCalendar: WorkforceCalendarDay[] = [
  ...
  { day: 5, weekday: 'Jum', status: 'WFH', color: 'bg-brand-50/50 text-primary', note: 'Hari kerja remote' },
  { day: 6, weekday: 'Sab', status: 'Libur', color: 'bg-slate-600/10 text-foreground', note: 'Hari libur perusahaan' },
  { day: 7, weekday: 'Min', status: 'Libur', color: 'bg-slate-600/10 text-foreground', note: 'Akhir pekan' },
  ...
  { day: 13, weekday: 'Sab', status: 'Libur', color: 'bg-slate-600/10 text-foreground', note: 'Akhir pekan' },
  { day: 14, weekday: 'Min', status: 'Libur', color: 'bg-slate-600/10 text-foreground', note: 'Akhir pekan' },
  { day: 15, weekday: 'Sen', status: 'Terlambat', color: 'bg-amber-50 text-amber-200', note: 'Keterlambatan lalu lintas' },
  { day: 16, weekday: 'Sel', status: 'WFH', color: 'bg-brand-50/50 text-primary', note: 'Hari remote' },
  ...
  { day: 20, weekday: 'Sab', status: 'Libur', color: 'bg-slate-600/10 text-foreground', note: 'Akhir pekan' },
  { day: 21, weekday: 'Min', status: 'Libur', color: 'bg-slate-600/10 text-foreground', note: 'Akhir pekan' },
  ...
  { day: 27, weekday: 'Sab', status: 'Libur', color: 'bg-slate-600/10 text-foreground', note: 'Akhir pekan' },
  { day: 28, weekday: 'Min', status: 'Libur', color: 'bg-slate-600/10 text-foreground', note: 'Akhir pekan' },
...
export const leaveCalendar: WorkforceCalendarDay[] = [
  ...
  { day: 6, weekday: 'Sab', status: 'Libur', color: 'bg-slate-600/10 text-foreground', note: 'Akhir pekan' },
  { day: 7, weekday: 'Min', status: 'Libur', color: 'bg-slate-600/10 text-foreground', note: 'Akhir pekan' },
];
