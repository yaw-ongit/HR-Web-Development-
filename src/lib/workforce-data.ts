...
export const attendanceCalendar: WorkforceCalendarDay[] = [
  { day: 1, weekday: 'Mo', status: 'Present', color: 'bg-emerald-500/10 text-emerald-200', note: 'Most employees on site' },
  { day: 2, weekday: 'Tu', status: 'Present', color: 'bg-emerald-500/10 text-emerald-200', note: 'Minimal late arrivals' },
  { day: 3, weekday: 'We', status: 'Late', color: 'bg-amber-500/10 text-amber-200', note: 'Executive town hall' },
  { day: 4, weekday: 'Th', status: 'Present', color: 'bg-emerald-500/10 text-emerald-200', note: 'Normal attendance' },
  { day: 5, weekday: 'Fr', status: 'WFH', color: 'bg-sky-500/10 text-sky-200', note: 'Remote work day' },
  { day: 6, weekday: 'Sa', status: 'Holiday', color: 'bg-slate-600/10 text-slate-200', note: 'Company holiday' },
  { day: 7, weekday: 'Su', status: 'Holiday', color: 'bg-slate-600/10 text-slate-200', note: 'Weekend' },
  { day: 8, weekday: 'Mo', status: 'Present', color: 'bg-emerald-500/10 text-emerald-200', note: 'High attendance' },
  { day: 9, weekday: 'Tu', status: 'Absent', color: 'bg-rose-500/10 text-rose-200', note: 'Planned leave starts' },
  { day: 10, weekday: 'We', status: 'Present', color: 'bg-emerald-500/10 text-emerald-200', note: 'Steady attendance' },
  { day: 11, weekday: 'Th', status: 'Business Trip', color: 'bg-violet-500/10 text-violet-200', note: 'Sales team travel' },
  { day: 12, weekday: 'Fr', status: 'Present', color: 'bg-emerald-500/10 text-emerald-200', note: 'Team planning session' },
  { day: 13, weekday: 'Sa', status: 'Holiday', color: 'bg-slate-600/10 text-slate-200', note: 'Weekend' },
  { day: 14, weekday: 'Su', status: 'Holiday', color: 'bg-slate-600/10 text-slate-200', note: 'Weekend' },
  { day: 15, weekday: 'Mo', status: 'Late', color: 'bg-amber-500/10 text-amber-200', note: 'Traffic delay' },
  { day: 16, weekday: 'Tu', status: 'WFH', color: 'bg-sky-500/10 text-sky-200', note: 'Remote day' },
  { day: 17, weekday: 'We', status: 'Present', color: 'bg-emerald-500/10 text-emerald-200', note: 'Strong attendance' },
  { day: 18, weekday: 'Th', status: 'Present', color: 'bg-emerald-500/10 text-emerald-200', note: 'Operational cadence' },
  { day: 19, weekday: 'Fr', status: 'Late', color: 'bg-amber-500/10 text-amber-200', note: 'Station closure' },
  { day: 20, weekday: 'Sa', status: 'Holiday', color: 'bg-slate-600/10 text-slate-200', note: 'Weekend' },
  { day: 21, weekday: 'Su', status: 'Holiday', color: 'bg-slate-600/10 text-slate-200', note: 'Weekend' },
  { day: 22, weekday: 'Mo', status: 'Present', color: 'bg-emerald-500/10 text-emerald-200', note: 'Core workforce present' },
  { day: 23, weekday: 'Tu', status: 'Business Trip', color: 'bg-violet-500/10 text-violet-200', note: 'Regional team travel' },
  { day: 24, weekday: 'We', status: 'Absent', color: 'bg-rose-500/10 text-rose-200', note: 'Office maintenance' },
  { day: 25, weekday: 'Th', status: 'Present', color: 'bg-emerald-500/10 text-emerald-200', note: 'Strong operations' },
  { day: 26, weekday: 'Fr', status: 'Late', color: 'bg-amber-500/10 text-amber-200', note: 'Late shift handoff' },
  { day: 27, weekday: 'Sa', status: 'Holiday', color: 'bg-slate-600/10 text-slate-200', note: 'Weekend' },
  { day: 28, weekday: 'Su', status: 'Holiday', color: 'bg-slate-600/10 text-slate-200', note: 'Weekend' },
  { day: 29, weekday: 'Mo', status: 'Present', color: 'bg-emerald-500/10 text-emerald-200', note: 'Planning day' },
  { day: 30, weekday: 'Tu', status: 'Present', color: 'bg-emerald-500/10 text-emerald-200', note: 'Regular attendance' },
];
...
export const leaveCalendar: WorkforceCalendarDay[] = [
  { day: 1, weekday: 'Mo', status: 'Approved', color: 'bg-emerald-500/10 text-emerald-200', note: 'Annual leave' },
  { day: 2, weekday: 'Tu', status: 'Pending', color: 'bg-amber-500/10 text-amber-200', note: 'Request review' },
  { day: 3, weekday: 'We', status: 'Sick', color: 'bg-rose-500/10 text-rose-200', note: 'Sick leave' },
  { day: 4, weekday: 'Th', status: 'Approved', color: 'bg-emerald-500/10 text-emerald-200', note: 'Marriage leave' },
  { day: 5, weekday: 'Fr', status: 'Approved', color: 'bg-emerald-500/10 text-emerald-200', note: 'Annual leave' },
  { day: 6, weekday: 'Sa', status: 'Holiday', color: 'bg-slate-600/10 text-slate-200', note: 'Weekend' },
  { day: 7, weekday: 'Su', status: 'Holiday', color: 'bg-slate-600/10 text-slate-200', note: 'Weekend' },
];
