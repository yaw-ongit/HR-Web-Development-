...
export const departmentOptions = ['People Ops', 'Engineering', 'Sales', 'Finance', 'Product', 'Legal', 'Customer Success'];
export const positionOptions = ['HR Generalist', 'Software Engineer', 'Sales Lead', 'Finance Manager', 'Product Designer', 'Legal Counsel', 'Customer Success Director'];
export const statusOptions = ['Active', 'On leave', 'Probation', 'Contract'];
export const contractOptions = ['Permanent', 'Fixed-term', 'Internship'];
export const branchOptions = ['Jakarta HQ', 'Singapore Office', 'London Hub', 'New York Studio'];
export const locationOptions = ['Jakarta', 'Singapore', 'London', 'New York', 'Remote'];
export const genderOptions = ['Female', 'Male', 'Non-binary'];
...
export const orgStructure = {
  ...
  team: [
    { name: 'Maya Thompson', role: 'HR Generalist' },
    { name: 'Zoe Kim', role: 'Product Designer' },
    { name: 'Emily Wong', role: 'Software Engineer' },
  ],
};

export const documentCenter = [
  { title: 'Employment contract', category: 'Contract', updated: 'May 2024', status: 'Signed' },
  { title: 'Performance review', category: 'HR', updated: 'Mar 2024', status: 'Finalized' },
  { title: 'Health insurance card', category: 'Benefits', updated: 'Jan 2024', status: 'Active' },
  { title: 'Training certification', category: 'Training', updated: 'Jun 2024', status: 'Completed' },
];
