...
export const dashboardKpis = {
  employee: [
    ...
    { label: 'Sisa Cuti', value: '12 hari', trend: '3 hari bulan ini', icon: 'Leaf', valueColor: 'text-primary' },
    { label: 'Pelatihan Mendatang', value: '1 sesi', trend: 'Mulai dalam 4 hari', icon: 'BookOpen', valueColor: 'text-primary' },
  ...
  supervisor: [
    ...
    { label: 'Karyawan Terlambat', value: '3', trend: 'Meningkat', icon: 'Clock', valueColor: 'text-primary' },
  ...
  administrator: [
    ...
    { label: 'Pengguna', value: '4,947', trend: 'Sesi aktif 128', icon: 'UserCheck', valueColor: 'text-primary' },
